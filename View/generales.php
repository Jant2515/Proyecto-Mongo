    ...
    <div class="site-wrap">
      ...
      <header class="site-navbar py-1" role="banner">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-6 col-xl-2">
              <h1 class="mb-0"><a href="index.php" class="text-black h2 mb-0">DestinosCR</a></h1>Administrador
            </div>
            <div class="col-10 col-md-8 d-none d-xl-block">
              <nav class="site-navigation position-relative text-right text-lg-center" role="navigation">
                <ul class="site-menu js-clone-nav mx-auto d-none d-lg-block">
  ...
  <div class="container">
    ...
    <div class="row pt-5 mt-5 text-center">
      <div class="col-md-12">
        ...
        <p>
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> Reservados todos los derechos | Relizado  <i class="icon-heart-o" aria-hidden="true"></i> por <a href="https://colorlib.com" target="_blank" >Grupo2</a>
        </p>
      </div>
  ...
  <div class="container">
    <div class="row">
      ...
      <div class="col-lg-4 mb-5 mb-lg-0">
        <div class="row mb-5">
          <div class="col-md-12">
            <h3 class="footer-heading mb-4">Navega</h3>
          </div>
          <div class="col-md-6 col-lg-6">
            <ul class="list-unstyled">
              <li><a href="#">Incio</a></li>
    ...
    <div class="row pt-5 mt-5 text-center">
      <div class="col-md-12">
        ...
        <p>
        Copyright &copy;<script>document.write(new Date().getFullYear());</script> Reservados todos los derechos  | Realizado  <i class="icon-heart-o" aria-hidden="true"></i> por <a href="https://colorlib.com" target="_blank" >Grupo2</a>
        </p>
      </div>
...
function allLinks()
{
  echo'<script src="View/js/jquery-3.3.1.min.js"></script>
